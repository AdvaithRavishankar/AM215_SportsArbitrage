...
class TestArbitrageDetection:
    ...
    def test_find_arbitrage_no_opportunities(self):
        ...
        odds_df = pd.DataFrame([
            {'game_id': 'g1', 'home_team': 'A', 'away_team': 'B',
             'sportsbook': 'Book1', 'team': 'A', 'odds': -110},
            {'game_id': 'g1', 'home_team': 'A', 'away_team': 'B',
             'sportsbook': 'Book1', 'team': 'B', 'odds': -110},
        ])
    ...
    def test_find_arbitrage_with_opportunities(self):
        ...
        odds_df = pd.DataFrame([
            {'game_id': 'g1', 'home_team': 'A', 'away_team': 'B',
             'sportsbook': 'Book1', 'team': 'A', 'odds': 200,
             'commence_time': pd.Timestamp('2023-01-01')},
            {'game_id': 'g1', 'home_team': 'A', 'away_team': 'B',
             'sportsbook': 'Book2', 'team': 'B', 'odds': 200,
             'commence_time': pd.Timestamp('2023-01-01')},
        ])
    ...
    def test_find_arbitrage_min_roi_filter(self):
        ...
        odds_df = pd.DataFrame([
            {'game_id': 'g1', 'home_team': 'A', 'away_team': 'B',
             'sportsbook': 'Book1', 'team': 'A', 'odds': 150,
             'commence_time': pd.Timestamp('2023-01-01')},
            {'game_id': 'g1', 'home_team': 'A', 'away_team': 'B',
             'sportsbook': 'Book2', 'team': 'B', 'odds': 150,
             'commence_time': pd.Timestamp('2023-01-01')},
        ])
    ...
    def test_find_arbitrage_return_columns(self):
        ...
        odds_df = pd.DataFrame([
            {'game_id': 'g1', 'home_team': 'A', 'away_team': 'B',
             'sportsbook': 'Book1', 'team': 'A', 'odds': -105,
             'commence_time': pd.Timestamp('2023-01-01')},
            {'game_id': 'g1', 'home_team': 'A', 'away_team': 'B',
             'sportsbook': 'Book2', 'team': 'B', 'odds': -105,
             'commence_time': pd.Timestamp('2023-01-01')},
        ])
        ...
        expected_columns = [
            ...
            'arbitrage_roi', 'home_stake_pct', 'away_stake_pct'
        ]
